...
write_dta(data2,"rrankm2.dta")
save(data2, file = "rrankm2.RData")
data1<-data2
```
```{r}
for (i in 1:1){
...
summary statistics
```{r}
data2 <- read_dta("rrankm2.dta")
data2 <- subset(data2,select = !(names(data2) %in% c("hidp","scend","edu3","gor_dv","refg","inc","agegrp","groupm1")))
