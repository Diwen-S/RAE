...
summary statistics
```{r}
data2 <- subset(data1,select = !(names(data1) %in% c("pidp","hidp","scend","edu3","gor_dv","refg","inc","agegrp","groupm1")))
...
save(data2,file = "use_reg.RData")
load("use_reg.RData")
write_dta(data2,"use_reg.dta")
